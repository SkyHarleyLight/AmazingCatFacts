...
class _$_CatFactModel implements _CatFactModel {
  const _$_CatFactModel(
      {@HiveField(0) required this.fact,
      @HiveField(1) @JsonKey(includeFromJson: false) this.image,
      @HiveField(2) @JsonKey(includeFromJson: false) this.creationDate});
  ...
  @override
  String toString() {
    return 'CatFactModel(fact: $fact, image: $image, creationDate: $creationDate)';
  }
...
abstract class _CatFactModel implements CatFactModel {
  const factory _CatFactModel(
      ...
      @HiveField(2)
      @JsonKey(includeFromJson: false)
          final String? creationDate}) = _$_CatFactModel;
